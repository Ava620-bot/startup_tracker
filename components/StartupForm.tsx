  ...
  return (
    <form action={formAction} className='startup-form'>
        <div>
            ...
            <Input type='' id='title' name='title' className='startup-form_input' required placeholder='Startup Title' />
            {errors?.title && (
        ...
        <div data-color-mode="light">
            ...
            <MDEditor
             ...
             preview='edit'
             height={300}
             style={{borderRadius: 20, overflow: 'hidden', border: "3px solid black", marginTop: '10px'}}
             textareaProps={{
                placeholder:
